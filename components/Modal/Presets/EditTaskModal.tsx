...
import { ActivityModeSelector, ActivityTypeSelector, EventAddressSelector, EventTitleSelector, MaxScoreSelector, QuestionsAmountSelector, SubjectsContentsSelector, SubjectSelector } from "../../../../old_pages/task/new";
