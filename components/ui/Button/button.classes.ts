...
export const neutral = [
	"p-[1.2rem] gap-8 bg-neutral border border-solid border-light-gray text-font-light font-sans w-full font-medium text-sm duration-[250ms] shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)]",
